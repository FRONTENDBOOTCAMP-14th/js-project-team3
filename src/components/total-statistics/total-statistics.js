document.addEventListener("DOMContentLoaded", function() {
  document.querySelectorAll(".input-list-item").forEach(function(li) {
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.addEventListener("click", function() {
    document.querySelectorAll(".match-type-list").forEach(function(dropdown) {
